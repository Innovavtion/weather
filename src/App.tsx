  ...
  return (
    <div className="max-w-screen-xl mx-auto">
      ...
      <div className="weather-card-container">
        <div className="weather-card bg-gradient-to-r from-gray-900 weather-card-unactive"></div>
        <div className="weather-card weather-card-active active-day"></div>
        <div className="weather-card bg-gradient-to-l from-gray-900 weather-card-unactive"></div>
      </div>
      <svg
        ...
        strokeWidth={2}
        stroke="white"
        className="w-14 h-14 max-w-screen-xl mx-auto my-28"
      >
